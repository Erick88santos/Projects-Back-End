...
# Definição macro para movimento da cobra.
...
while not game_over:
    ...
    if collision(snake[0], apple_pos):
     ...
     # Verificando se a cobra colidiu com os limites
    if snake[0][0] == 600 or snake[0][1] == 600 or snake[0][0] < 0 or snake[0][1] < 0:
        game_over = True
        break

    # Verificando se a cobra atingiu a si mesma
    ...
    # na realidade, faça a cobra se mover..
    if my_direction == UP:
